...
const Login = () => {
  ...
  const handleFormSubmit = async (data: UserLoginType) => {
    ...
    try {
      ...
      // Redirect based on backend logic
    ...
    <div className='h-screen w-screen grid grid-cols-1 md:grid-cols-2'>
      ...
      <div className='flex flex-col items-center justify-center h-full p-12 bg-white'>
        <div className='w-full max-w-md'>
          ...
          <h1 className="text-2xl font-bold text-center text-blue-950">Login</h1>
          <p className="text-center text-gray-600 mt-2 mb-3">Login into your smartcare account</p>
