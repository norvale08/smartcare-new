      ...
      <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-3 sm:p-4 md:p-5 border-2 border-red-100 mb-3 sm:mb-4">
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            />
            {errors.systolic && <p className="text-red-600 text-xs mt-1 font-medium">{errors.systolic.message}</p>}
          </div>
          {/* Diastolic */}
          <div>
            ...
            />
            {errors.diastolic && <p className="text-red-600 text-xs mt-1 font-medium">{errors.diastolic.message}</p>}
          </div>
          {/* Heart Rate */}
          <div>
            ...
            />
            {errors.heartRate && <p className="text-red-600 text-xs mt-1 font-medium">{errors.heartRate.message}</p>}
          </div>
        </div>
      </div>
    </div>
