...
const CardiovascularSection: React.FC<CardiovascularSectionProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg p-4 sm:p-5 md:p-6 lg:p-8 hover:shadow-xl transition-shadow animate-in fade-in slide-in-from-top-2 duration-300">
      ...
      {/* Pro tip */}
      <div className="flex items-start gap-2 mb-4 sm:mb-5 bg-blue-50/80 rounded-xl p-3 sm:p-4 border border-blue-100">
        <Clock className="text-blue-500 mt-0.5 flex-shrink-0" size={14} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
        ...
        >
          ...
          <Input
            ...
            className={`w-full border-2 rounded-lg px-3 py-2 text-sm sm:text-base focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 transition-all bg-white ${
              errors.systolic ? 'border-red-500 bg-red-50' : 'border-gray-200'
            }`}
        ...
        {/* Diastolic */}
        <div
          ref={setFieldRef('diastolic')}
          style={getFieldStyle('diastolic')}
          className="bg-gray-50 rounded-xl p-4 sm:p-5 border border-gray-100 hover:bg-gray-50/80 transition-colors"
        >
          <Label 
            htmlFor="diastolic" 
          ...
          <Input
            ...
            className={`w-full border-2 rounded-lg px-3 py-2 text-sm sm:text-base focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 transition-all bg-white ${
              errors.diastolic ? 'border-red-500 bg-red-50' : 'border-gray-200'
            }`}
        ...
        {/* Heart Rate */}
        <div
          ref={setFieldRef('heartRate')}
          style={getFieldStyle('heartRate')}
          className="bg-gray-50 rounded-xl p-4 sm:p-5 border border-gray-100 hover:bg-gray-50/80 transition-colors"
        >
          <Label 
            htmlFor="heartRate" 
          ...
          <Input
            ...
            className={`w-full border-2 rounded-lg px-3 py-2 text-sm sm:text-base focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/20 transition-all bg-white ${
              errors.heartRate ? 'border-red-500 bg-red-50' : 'border-gray-200'
            }`}
      ...
      {/* Helpful Info */}
      {isBPRequired && (
        <div className="mt-4 sm:mt-5 text-xs sm:text-sm text-gray-600 bg-blue-50/80 rounded-xl p-3 sm:p-4 border border-blue-100">
