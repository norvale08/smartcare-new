      ...
      >
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 sm:p-4 md:p-5 border-2 border-green-100">
          ...
          <div>
            ...
            {errors.exerciseRecent && <p className="text-red-600 text-xs mt-1 font-medium">{errors.exerciseRecent.message}</p>}
          </div>
        </div>
      </div>
      ...
      >
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 sm:p-4 md:p-5 border-2 border-green-100">
          <div>
            ...
            {errors.exerciseIntensity && <p className="text-red-600 text-xs mt-1 font-medium">{errors.exerciseIntensity.message}</p>}
          </div>
        </div>
      </div>
    </>
