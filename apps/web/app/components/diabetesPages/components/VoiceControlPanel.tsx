...
import { VoiceModeState } from '../utils/formUtils';
  ...
  return (
    <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 mb-4 sm:mb-6">
      ...
      <button 
        ...
        className="w-full bg-white text-purple-600 font-bold py-3 rounded-lg hover:bg-gray-100 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:bg-white animate-in fade-in slide-in-from-top-2 duration-300"
      >
        {active ? (
          <>
            <Pause size={20} />
