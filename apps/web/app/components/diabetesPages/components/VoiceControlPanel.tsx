      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            {paused && (
              <p className="text-yellow-300 text-xs sm:text-sm font-semibold animate-pulse">
      ...
      <div className="flex gap-2">
        ...
        {!active ? (
          <button 
            ...
            className="flex-1 bg-white text-purple-600 font-bold py-3 rounded-lg hover:bg-gray-100 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base animate-in fade-in slide-in-from-top-2 duration-300"
          >
            <Play size={20} />
          ...
          <>
            ...
            <button 
              type="button"
              onClick={onToggleVoiceMode}
              className="flex-1 bg-red-500 text-white font-bold py-3 rounded-lg hover:bg-red-600 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2 text-sm sm:text-base"
            >
              <Square size={20} />
