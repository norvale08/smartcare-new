...
const Page = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="sticky top-0 z-50 w-full bg-gradient-to-r from-emerald-100 to-teal-100 shadow-sm border-b border-emerald-200">
        <UserProfileHeader 
      ...
      <div className="lg:hidden fixed top-20 right-4 z-40">
        <button
          ...
          className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-3 rounded-full shadow-lg hover:from-emerald-700 hover:to-teal-700 transition-colors"
        >
      ...
      `}>
        <div className="pt-6 px-6 pb-6 h-full flex flex-col">
          <div className="flex-1 overflow-y-auto">
            <h2 className="text-lg font-bold bg-gradient-to-r from-emerald-700 to-teal-700 bg-clip-text text-transparent mb-4">{currentLanguage.title}</h2>
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-2 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors shadow-sm z-10"
            ...
            <div className="bg-white rounded-lg border border-emerald-200/50 p-3 mb-4">
          ...
          <button
            onClick={() => setMobileMenuOpen(false)}
            className="mt-6 bg-gradient-to-r from-emerald-100 to-teal-100 text-emerald-800 py-3 rounded-lg font-semibold hover:from-emerald-200 hover:to-teal-200 transition-all shadow-sm border border-emerald-200"
          >
      ...
      {showTrends && (
        <div className="fixed inset-0 bg-white z-50">
          {/* Sticky Header */}
          <div className="sticky top-0 bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-4 md:p-6 flex items-center justify-between z-10 shadow-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-teal-100 text-sm md:text-base">{currentLanguage.trendsSubtitle}</p>
              </div>
            </div>
            <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-teal-50 to-emerald-50 rounded-xl p-6 border border-teal-200">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-teal-800">Fasting Glucose</h4>
                      <p className="text-teal-700">Target: 80-130 mg/dL</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-teal-800">Blood Pressure</h4>
                      <p className="text-teal-700">{'Target: <140/90 mmHg'}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-teal-800">Post-Meal Glucose</h4>
                      <p className="text-teal-700">{'Target: <180 mg/dL (2 hours after eating)'}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-emerald-200 p-4 shadow-lg">
            <div className="max-w-7xl mx-auto">
              <button
                onClick={() => setShowTrends(false)}
                className="w-full md:w-auto bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-3 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors font-semibold shadow-md"
              >
      ...
      <div className={`max-w-[1600px] mx-auto px-3 sm:px-4 lg:px-6 py-4 lg:py-6 ${showTrends ? 'hidden' : 'block'}`}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-emerald-200/50 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-3 py-1.5 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors shadow-sm text-xs font-semibold flex items-center gap-1.5"
                  >
                    ...
                    return (
                      ...
                      >
                        <Icon className={`w-4 h-4 flex-shrink-0 ${
                          isActive ? "text-white" : isDisabled ? "text-gray-300" : "text-emerald-600 group-hover:text-emerald-700"
                        }`} />
          ...
          <div className="lg:col-span-9">
            ...
            {/* Content Card */}
            <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm border border-emerald-200/50 overflow-hidden">
              {/* Header */}
              <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white p-4 md:p-6">
              ...
              <div className="p-4 md:p-6 min-h-[400px] max-h-[calc(100vh-200px)] overflow-y-auto bg-gradient-to-b from-white to-emerald-50/30">
                {activeTab === "vitals" && (
                      ...
                      <>
                        ...
                        <div className="pt-6 border-t border-emerald-200/50">
                          <button
                            ...
                            className="w-full sm:w-auto bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-3 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors font-semibold flex items-center justify-center gap-2"
                          >
                ...
                {activeTab === "final" && (
                  <div className="space-y-6">
                    ...
                    {finalFeedback && (
                      <div className="bg-teal-50 border border-emerald-900/20 rounded-lg p-4 md:p-6">
                        ...
                        <p className="text-teal-900 text-base">
                    ...
                    <div className="pt-6 border-t border-emerald-200/50">
                      <button
                        ...
                        className="w-full sm:w-auto bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-3 px-8 rounded-lg hover:from-emerald-700 hover:to-teal-700 transition-colors font-semibold flex items-center justify-center gap-2"
                      >
