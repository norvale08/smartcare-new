  ...
  return (
    <header className="flex justify-between items-center px-8 py-4 bg-transparent">
      <div className="flex flex-row items-center gap-2">
        <HeartPulse className="text-gray-800" size={24} />
      ...
      <div className="flex flex-row items-center gap-6">
        <div className="relative">
          <select
            ...
            className="flex flex-row bg-gray-100 text-gray-800 border border-gray-300 items-center justify-center gap-2 px-3 py-2 rounded-lg hover:bg-gray-200 transition-colors appearance-none pr-8"
          >
          ...
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 pointer-events-none">
            <Globe className="text-gray-800" size={16} />
          </div>
        </div>
